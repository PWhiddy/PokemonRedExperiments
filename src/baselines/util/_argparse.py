...
def get_args():
    ...
    parser.add_argument('--headless', action=BooleanOptionalAction, default=False, help='Whether to run the environment in headless mode')
    ...
    if args.cpu_count > cpu_count:
        msg = f"Provided CPU count {args.cpu_count} greater than actual CPU count {cpu_count}. Performance may suffer."
