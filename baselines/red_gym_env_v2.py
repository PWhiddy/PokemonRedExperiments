...
class RedGymEnv(Env):
    def __init__(self, config=None):
        ...
        self.extra_buttons = (
            False if "extra_buttons" not in config else config["extra_buttons"]
        )
        self.instance_id = (
            str(uuid.uuid4())[:8]
        ...
        self.output_full = (
            ...
            + 1 * (self.mem_padding + self.memory_height),
            self.output_shape[1],
            self.output_shape[2],
        )
    ...
    def check_if_done(self):
        ...
        # done = self.read_hp_fraction() == 0 # end on losing battle
        return done
    ...
    def get_levels_sum(self):
        ...
        return max(sum(poke_levels) - starter_additional_levels, 0)  # subtract starting pokemon level
    ...
    def get_game_state_reward(self, print_stats=False):
        ...
        state_scores = {
            ...
            "level": self.reward_scale * self.get_levels_sum(),
    ...
    # built-in popcount since python 3.10
